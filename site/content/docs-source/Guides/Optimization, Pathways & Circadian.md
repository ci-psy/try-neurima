...
- **Restore** the default pathway set (Relax, Balance, Focus)
- **Clear all** pathways
...
- `Locked` behavior mode is unavailable while Circadian is enabled.
...
## Pathways and Circadian

**Pathways** let you choose a region of the timing range by hand. You create named presets and switch between them from the player.

**Circadian** follows a daily schedule. Instead of choosing a region, the app maps the full range to your wake/sleep cycle and adjusts throughout the day.
