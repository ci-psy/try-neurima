...
export function DocsMobileNav({
  ...
  return (
    <div className="docs-mobile-nav lg:hidden">
      <details className="docs-mobile-panel">
        <summary className="docs-mobile-summary">Browse Docs</summary>
        <div className="docs-mobile-panel-body">
          {sections.map((section) => (
            <div key={section.id} className="docs-mobile-section">
              <Link href={section.href} className="docs-sidebar-section-title">
                {section.title}
              </Link>
              <div className="mt-2 flex flex-col gap-1">
      ...
      {headings.length > 0 ? (
        <details className="docs-mobile-panel">
          <summary className="docs-mobile-summary">On This Page</summary>
          <div className="docs-mobile-panel-body">
            <div className="flex flex-col gap-2">
              {headings.map((heading) => (
                <a
                  key={heading.id}
                  href={`#${heading.id}`}
                  className={`docs-toc-link ${heading.level === 3 ? 'docs-toc-link-sub' : ''}`}
                >
                  {heading.text}
                </a>
              ))}
    ...
    <header className="mb-10">
      <div className="docs-article-meta">
        <div className="docs-article-breadcrumbs">
          <Link href="/docs/" className="docs-article-breadcrumb-link">
            Docs
          </Link>
          <span className="docs-article-breadcrumb-separator" aria-hidden>
            /
          </span>
          <Link href={article.section.href} className="docs-article-breadcrumb-link">
            {article.section.title}
          </Link>
        </div>
        <div className="docs-article-reading-time">
