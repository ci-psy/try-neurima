...
const sectionDefinitions: DocSectionDefinition[] = [
  {
    ...
    description: 'First-run setup, adding audio, and the first listening flow.',
    itemLabel: 'Getting started',
  },
  {
    id: 'guides',
    title: 'Guides',
    description: 'Playback controls, pathway tuning, Sound Lab, visualization, and data management.',
    itemLabel: 'Guide',
  },
  {
    id: 'research',
    title: 'Research',
    description: 'How IMA works and how Neurima applies it during playback.',
    itemLabel: 'Research',
  },
]
...
const articleDefinitions: DocArticleDefinition[] = [
  {
    ...
    description: 'Requirements, source options, and default first-session setup.',
  },
  {
    id: 'first-listen',
    section: 'getting-started',
    ...
    description: 'Adding audio, player basics, and a first playback session.',
  },
  {
    id: 'player-playlist',
    section: 'guides',
  ...
  },
  {
    ...
    description: 'Ambient creation, sound design, sessions, and export.',
  },
  {
    id: 'visualization',
    section: 'guides',
  ...
  },
  {
    ...
    description: 'Permissions, media sources, and configuration transfer.',
  },
  {
    id: 'how-ima-works',
    section: 'research',
    ...
    description: 'IMA and the playback model in plain language.',
  },
  {
    ...
    description: 'A manual offline version of the channel-desync method in Audacity.',
  },
]
...
function buildDocsData() {
  ...
  const homeIntro =
    homeDocument.blocks.find((block): block is Extract<DocBlock, { type: 'paragraph' }> => block.type === 'paragraph')
      ?.text ?? 'Neurima applies sample-level timing differences between stereo channels during playback.'
...
export function getDocsHomeIntro() {
  return getDocsDataCached().homeIntro
}
