...
import { type DocSectionId, getDocSections, getDocsHomeIntro } from './docs-data'

export const metadata: Metadata = {
  title: 'Docs - Neurima',
  description: 'Documentation for setup, playback, Sound Lab, Circadian, and other Neurima features.',
  alternates: {
    ...
    <main id="main" className="min-h-screen px-6">
      <div className="max-w-[960px] mx-auto pt-[17.5vh] pb-24 animate-page-enter">
        <section className="max-w-[720px]">
          ...
          <p className="mt-5 text-[16px] leading-[1.85] text-secondary">
            {intro}
          </p>
        </section>
