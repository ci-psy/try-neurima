      ...
      <div className="max-w-[960px] mx-auto pt-[17.5vh] pb-24 animate-page-enter">
        ...
        <div className="space-y-10 text-[15px] text-secondary leading-[1.75]">
          ...
          <section>
            ...
            <p>
              Neurima is an experimental psychoacoustic audio player built around Imperceptible Musical Augments (IMA).
              It applies timing desynchronization during playback to your own local audio for personal listening and
              general wellness exploration. The underlying research is promising and exploratory, but it has not been
              established as a medical treatment or clinical service.
            </p>
          </section>
