...
export function Nav() {
  ...
  return (
    ...
    <nav className={`sticky top-0 z-50 px-6 transition-[backdrop-filter,background,border-color] duration-300 ${scrolled ? 'backdrop-blur-xl bg-[var(--color-nav-bg)] border-b border-[var(--color-nav-border)]' : 'border-b border-transparent'}`}>
      <div className="site-nav-shell py-3 max-w-[960px] mx-auto">
        <Link href="/" className="site-nav-brand">
          ...
          <span className="site-nav-wordmark text-[15px] font-medium">Neurima</span>
        </Link>
        <div className="site-nav-links text-[14px]">
          <Link href="/story/" className={`site-nav-link transition-colors ${isStory ? 'text-[var(--color-fg)]' : 'text-secondary hover:text-[var(--color-fg)]'}`}>
          ...
          <Link href="/docs/" className={`site-nav-link transition-colors ${isDocs ? 'text-[var(--color-fg)]' : 'text-secondary hover:text-[var(--color-fg)]'}`}>
            <svg className="w-[15px] h-[15px] hidden sm:block" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
          ...
          <Link href="/faq/" className={`site-nav-link transition-colors ${isFaq ? 'text-[var(--color-fg)]' : 'text-secondary hover:text-[var(--color-fg)]'}`}>
            <svg className="w-[15px] h-[15px] hidden sm:block" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
              <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z" />
            </svg>
            FAQs
          </Link>
          <a href={APP_STORE_URL} className="pill-ghost site-nav-download" aria-label="Download Neurima for iOS">
            ...
            <span className="site-nav-download-label">Download</span>
          </a>
        </div>
      </div>
      <div
...
export function Footer() {
  ...
  return (
    <footer className="px-6 py-10 border-t border-[var(--color-nav-border)]">
      <div className="max-w-[960px] mx-auto flex flex-col items-center justify-between gap-5 sm:flex-row sm:items-center">
        <div className="flex flex-col items-center gap-3 text-[13px] text-muted sm:items-start">
