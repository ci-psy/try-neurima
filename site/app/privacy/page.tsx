      ...
      <div className="max-w-[960px] mx-auto pt-[17.5vh] pb-24 animate-page-enter">
        ...
        <div className="space-y-10 text-[15px] text-secondary leading-[1.75]">
          ...
          <section>
            ...
            <p className="mb-4">Neurima may ask for permissions depending on the features you use:</p>
            <ul className="space-y-2 list-disc list-inside">
              <li>Media Library Access: Optional for browsing songs from your Music library. File imports, generated tracks, and Sound Lab creations still work without it.</li>
              <li>Notifications: Optional for export alerts. Export status still appears in-app without them.</li>
            </ul>
          </section>
