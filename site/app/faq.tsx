...
const faqs = [
  ...
  },
  {
    ...
    a: 'No. Binaural beats use simple tones at slightly different frequencies. Neurima applies timing desynchronization at the audio sample level to music or audio you choose, changing timing rather than adding audible tones.',
  },
  {
    q: 'What does Circadian do?',
    a: 'Circadian stops using individual pathways as the active region and instead maps the full timing range across your day. It uses your wake time, sleep time, and selected chronotype to reshape the desynchronization through the day.',
  },
  {
    q: 'What effects can I expect?',
    a: 'In the underlying research and listener reports, effects ranged from relaxation and focus to altered listening texture and a more immersive or meditative state. Some listeners notice a difference within a single track. Responses still vary by person, music, setup, and listening style.',
  },
  {
  ...
  {
    q: 'Will this hurt me?',
    a: "In the underlying study, 71 participants completed the protocol with zero reported adverse events. Neurima uses non-invasive audio timing changes only; there is no electrical stimulation or physical intervention.\n\nStill, use your own judgment. If listening feels unpleasant or raises concerns for you, stop using it.",
  },
  {
    q: 'Are there long-term benefits?',
    a: "The longer-range neuroplasticity idea is part of the broader IMA theory and one reason some listeners use Neurima regularly. That said, long-term outcomes remain exploratory rather than guaranteed.\n\nIn practice, variety matters: new music appears to keep the listening effect fresher, while repeating the same tracks too often can make the experience feel less pronounced over time.",
  },
  {
