...
const faqs = [
  ...
  },
  {
    ...
    a: "Unfortunately, no. Streaming services use content protection that prevents real-time audio processing at the system level - even for temporary processing that never stores anything.\n\nFor now, bring your own audio: import files through the Files app, sync music from the Apple Music app on Mac to your iPhone, or use iTunes Store purchases that have been downloaded to the device. Synced files are usually the better option because you can choose higher-quality copies such as ALAC or other lossless audio.\n\nImportant distinction: Apple Music subscription downloads currently do not work here. Even when they appear downloaded in the Music app, they remain DRM-protected subscription copies rather than ordinary local audio files, so Neurima cannot open them for processing. Purchased iTunes Store tracks and synced files do work because iOS exposes them as local media Neurima can access.",
  },
  {
