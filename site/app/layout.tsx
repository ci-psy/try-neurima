...
export const metadata: Metadata = {
  title: 'Neurima - Same music. Deeper listening.',
  description:
    'Neurima is an experimental psychoacoustic audio player built around Imperceptible Musical Augments (IMA) for personal listening and general wellness exploration.',
  icons: {
    icon: [
