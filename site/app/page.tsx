...
import { HomeAudioDemo } from './home-audio-demo'
      ...
      <section id="hero" className="min-h-[100svh] flex flex-col justify-center px-6">
        <div className="animate-fade-up max-w-[960px] mx-auto w-full">
          ...
          <p className="text-[17px] text-secondary leading-relaxed max-w-[600px] mb-10">
            Neurima is an experimental psychoacoustic audio player built around Imperceptible Musical Augments (IMA). It shifts stereo timing at the sample level during playback for personal listening and general wellness exploration.
          </p>
          <a href={APP_STORE_URL} className="pill pill-hero" aria-label="Download Neurima for iOS">
      ...
      <section id="how" className="px-6 py-24">
        <div className="max-w-[960px] mx-auto">
          ...
          <div className="flex flex-col gap-6 text-[16px] text-secondary leading-[1.75] max-w-[600px]">
            ...
            <Reveal><p>People use them to relax and focus.</p></Reveal>
            <Reveal><p>Their audibility creates interference.</p></Reveal>
            <div className="h-4" />
            <Reveal><p>Neurima alters time.</p></Reveal>
            <Reveal><p>Imperceptible Musical Augments.</p></Reveal>
            <Reveal><p>Below awareness. Below interference.</p></Reveal>
          </div>
        </div>
      </section>
